...
final String appName = 'Fasto Driver';
bool notificationStatus = true;
int notificationId = 1;
final String packageName = 'com.fasto.driver';
const String languageCode = 'languageCode';
final String baseUrl =
    // 'https://developmentalphawizz.com/why_taxi/api/Authentication/';
    'https://bikebooking.alphawizzserver.com/api/Authentication/';
...
final String baseUrl1 = 'https://bikebooking.alphawizzserver.com/api/';
final String imgUrl = 'https://bikebooking.alphawizzserver.com/';
