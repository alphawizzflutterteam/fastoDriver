    ...
    try {
      ...
      if (response['status']) {
        ...
        for (var v in response['data']) {
          setState(() {
            if (response['balance_all'].toString() != null &&
