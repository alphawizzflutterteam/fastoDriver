...
import 'package:pristine_andaman_driver/DrawerPages/bonus_info.dart';
import 'package:pristine_andaman_driver/Model/details_model.dart';
...
class _JoiningBonusState extends State<JoiningBonus>
                                                      ...
                                                      return detailList[index]
                                                          ...
                                                          ? Container(
                                                              ...
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  text(
                                                                      getTimeDate(DateTime.parse(detailList[index]
                                                                              .startDate
                                                                              .toString())) +
                                                                          "-" +
                                                                          getTimeDate(DateTime.parse(detailList[index]
                                                                  ...
                                                                  text(
                                                                      ...
                                                                      textColor:
                                                                          MyColorName
                                                                              .colorTextPrimary),
                                                                  text(
                                                                      "${int.parse(detailList[index].trips.toString()) - int.parse(detailList[index].count.toString())}/${DateTime.parse(detailList[index].endDate.toString()).difference(DateTime.parse(detailList[index].startDate.toString())).inDays} days",
                                                                      fontFamily:
                                                                          fontMedium,
                                                                      fontSize:
                                                                          10.sp,
                                              ...
                                              subtitle: Column(
                                                ...
                                                children: [
                                                  text(
                                                      ...
                                                      textColor: MyColorName
                                                          .colorTextPrimary),
                                                  int.parse(detailList[index]
                                                                  .trips
                                                                  .toString()) -
                                                              int.parse(detailList[
                                                                      index]
                                                                  .count
                                                                  .toString()) >
                                                          0
                                                      ? text(
                                                          "Left Trip-${int.parse(detailList[index].trips.toString()) - int.parse(detailList[index].count.toString())}",
                                                          fontFamily:
                                                              fontMedium,
                                                          fontSize: 10.sp,
                                                          textColor: MyColorName
