...
import 'package:pristine_andaman_driver/BookRide/complete_ride_dialog.dart';
import 'package:pristine_andaman_driver/Components/row_item.dart';
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: Container(
                                    ...
                                    child: Image.network(
                                      "$imagePath${widget.model.userImage.toString().split("/").last}",
                                      height: getWidth(72),
                                      width: getWidth(72),
                                      errorBuilder:
                                                  ...
                                                  children: [
                                                    text("Base fare : ",
                                                        ...
                                                        textColor:
                                                            Colors.black),
                                                    text(
                                                        "₹ ${double.parse(widget.model.baseFare.toString()).toStringAsFixed(2)}",
                                                        fontSize: 10.sp,
                                                        fontFamily: fontRegular,
                                                        textColor:
                                                            Colors.black),
                              ...
                              ClipRRect(
                                ...
                                child: Container(
                                  ...
                                  decoration: boxDecoration(
                                      radius: 12, color: Colors.grey),
                                  child: Image.network(
                                    "${widget.model.vehicalImege.toString()}",
                                    height: getWidth(72),
                                    width: getWidth(72),
                                  ),
                                ),
