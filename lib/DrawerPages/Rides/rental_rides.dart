...
import 'package:pristine_andaman_driver/BookRide/payment_dailog.dart';
import 'package:pristine_andaman_driver/DrawerPages/Rides/my_rides_page.dart';
import 'package:pristine_andaman_driver/Model/latlng_model.dart';
      ...
      if (mounted) {
        ...
        if (indexSelected != null && indexSelected != -1) {
          if (lastLat != latitude) {
            ...
            apiBase.postAPICall(
                Uri.parse(
                    "https://bikebooking.alphawizzserver.com/api/Payment/driver_last_lat_lang"),
                {
                  "driver_id": curUserId,
