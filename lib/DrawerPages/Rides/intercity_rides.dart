...
import 'package:pristine_andaman_driver/Model/intercity_model.dart';
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          ExpansionTile(
                                            ...
                                            children: [
                                              Text(
                                                "Click on check icon after pickup customer.",
                                                style: TextStyle(
                                                    color: Colors.red),
                                              ),
                                              if (rideList[index]
                                                                            ...
                                                                            AlertDialog(
                                                                              ...
                                                                              actions: [
                                                                                ...
                                                                                TextButton(
                                                                                    onPressed: () {
                                                                                      Navigator.pop(context);
                                                                                      launch("tel://${rideList[index].shareUserData![i].mobile}");
                                                                                    },
                                                                                    child: Text("Confirm")),
                                                                              ],
                                                                            ));
                                                                                ...
                                                                                AlertDialog(
                                                                                  ...
                                                                                  actions: [
                                                                                    ...
                                                                                    TextButton(
                                                                                        onPressed: () {
                                                                                          Navigator.pop(context);
                                                                                          pickupPerson(rideList[index].bookingId!, rideList[index].shareUserData![i].userId);
                                                                                        },
                                                                                        child: Text("Confirm")),
                                                                                  ],
                                                                                ));
