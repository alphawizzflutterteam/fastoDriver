                  ...
                  child: rideAccepted
                      ? Padding(
                          ...
                          child: Row(
                            children: [
                              Text(
                                  getTranslated(context, Strings.GO_TO_PICKUP)!,
                                  style: Theme.of(context)
                                      .textTheme
                                      .headlineSmall!
                                      .copyWith(
                                          letterSpacing: 0.7, fontSize: 16)),
                              Spacer(),
                              Text(
                                getTranslated(context, Strings.NAVIGATE)!
                                    .toUpperCase(),
                                style: Theme.of(context)
                                    .textTheme
                                    .headlineSmall!
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                getTranslated(
                                    context, Strings.PICKUP_DESTINATION)!,
                                style: theme.textTheme.headlineSmall,
                              ),
                              SizedBox(
                                height: 4,
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Spacer(),
                    buildFlatButton(
                        Icons.close, getTranslated(context, Strings.CANCEL)!),
                    Spacer(),
                    buildFlatButton(
                        isOpened
              ...
              child: Column(
                children: [
                  ListTile(
                    ...
                    trailing:
                        Text('08 km', style: theme.textTheme.headlineSmall),
                  ),
                  ListTile(
                    leading: Icon(
                      Icons.location_on,
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  buildRowItem(
                      theme,
                      getTranslated(context, Strings.RIDE_TYPE)!,
                      getTranslated(context, Strings.GO_PRIVATE)!,
                      Icons.drive_eta),
                ],
              ),
            ),
    ...
    return Column(
      ...
      children: [
        Text(
          title,
          style:
              theme.textTheme.headlineSmall!.copyWith(color: theme.hintColor),
        ),
        SizedBox(height: 8),
        Row(
          children: [
