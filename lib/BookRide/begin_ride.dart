...
import 'package:pristine_andaman_driver/BookRide/rate_ride_dialog.dart';
              ...
              children: [
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        buildFlatButton(Icons.call,
                            getTranslated(context, Strings.CALL_NOW)!),
                        SizedBox(width: 8),
                        buildFlatButton(Icons.close,
                            getTranslated(context, Strings.CANCEL)!, () {
